    ...
    <div class="glass-container">
        ...
        <div class="page-gallery-section">
            <div class="page-gallery-header">
                ...
                <p class="page-gallery-sub">Professional Career</p>
            </div>
            <div class="gallery-filter-bar">
                <button class="gallery-filter-btn active" data-filter="all">All</button>
                <button class="gallery-filter-btn" data-filter="pro-india">Journey in India</button>
                <button class="gallery-filter-btn" data-filter="pro-us">Journey in the USA</button>
            </div>
            <div class="gallery-masonry">
                <div class="gallery-item" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final1.PNG" alt="Professional India" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — India</span></div>
                </div>                <div class="gallery-item" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final2.jpg" alt="Professional India" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — India</span></div>
                </div>                <div class="gallery-item" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final3.PNG" alt="Professional India" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — India</span></div>
                </div>                <div class="gallery-item" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final4.jpeg" alt="Professional India" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — India</span></div>
                </div>                <div class="gallery-item" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final5.jpg" alt="Professional India" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — India</span></div>
                </div>                <div class="gallery-item" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final2.jpg" alt="Professional US" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — USA</span></div>
                </div>                <div class="gallery-item" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final3.jpg" alt="Professional US" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — USA</span></div>
                </div>                <div class="gallery-item" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final5.jpg" alt="Professional US" loading="lazy">
                    <div class="gallery-item-overlay"><span>Professional Journey — USA</span></div>
                </div>
            </div>
            ...
            <div class="mobile-deck" id="mobileDeck">
                ...
                <div class="mobile-deck-slide" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final1.PNG" alt="Professional Journey — India" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — India</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                </div>
                <div class="mobile-deck-slide" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final2.jpg" alt="Professional Journey — India" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — India</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                ...
                <div class="mobile-deck-slide" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final3.PNG" alt="Professional Journey — India" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — India</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                ...
                <div class="mobile-deck-slide" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final4.jpeg" alt="Professional Journey — India" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — India</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                ...
                <div class="mobile-deck-slide" data-category="pro-india" data-caption="Professional Journey — India">
                    <img src="assets/Professional Journey  India/0_Final5.jpg" alt="Professional Journey — India" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — India</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                </div>
                <div class="mobile-deck-slide" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final2.jpg" alt="Professional Journey — USA" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — USA</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                </div>
                <div class="mobile-deck-slide" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final3.jpg" alt="Professional Journey — USA" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — USA</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
                ...
                <div class="mobile-deck-slide" data-category="pro-us" data-caption="Professional Journey — USA">
                    <img src="assets/Professional Journey in the US/0_Final5.jpg" alt="Professional Journey — USA" loading="lazy">
                    <div class="mobile-deck-info">
                        <span class="mobile-deck-category">Professional Journey — USA</span>
                        <span class="mobile-deck-counter"></span>
                    </div>
