    ...
    <section id="home" class="hero">
        ...
        <div class="minimal-mobile-hero">
            ...
            <div class="minimal-col">
                <div style="font-family: 'Times New Roman', Times, serif; font-weight: bold; color: #000; font-size: clamp(2.5rem, 8vw, 4rem) !important; margin-bottom: 0.5rem; text-decoration: underline; text-underline-offset: 4px; text-decoration-thickness: 2px; text-transform: uppercase;">FEATURED WORK</div>
            ...
            <div class="minimal-col">
                <div style="font-family: 'Times New Roman', Times, serif; font-weight: bold; color: #000; font-size: clamp(2.5rem, 8vw, 4rem) !important; margin-bottom: 0.5rem; text-decoration: underline; text-underline-offset: 4px; text-decoration-thickness: 2px; text-transform: uppercase;">THE AUTHOR</div>
